...
class LhmTest extends AbstractPersistenceTest
{
    ...
    {
        $time = time();
        $this->environment->executeMigration(new InitialMigration('test', $time - 1), MigrationInterface::UP);
        $this->environment->executeMigration(new LhmMigration('test', $time), MigrationInterface::UP);
    ...
    public function testMigrateHybrid()
    {
        $time = time();
        $this->environment->executeMigration(new InitialMigration('test', $time - 1), MigrationInterface::UP);
        $this->environment->executeMigration(new HybridPhinxMigration('test', $time), MigrationInterface::UP);
    ...
    public function testAddIndex()
    {
        $time = time();
        $this->environment->executeMigration(new InitialMigration('test', $time - 1), MigrationInterface::UP);
        $this->environment->executeMigration(new IndexMigration('test', $time), MigrationInterface::UP);
    ...
    public function testRemoveIndex()
    {
        ...
        $this->environment->executeMigration(new InitialMigration('test', $time - 1), MigrationInterface::UP);
        $this->environment->executeMigration(new IndexMigration('test', $time), MigrationInterface::UP);
        $this->environment->executeMigration(new IndexMigration('test', $time), MigrationInterface::DOWN);
    ...
    public function testRenameColumn()
    {
        ...
        $this->environment->executeMigration(new RenameMigration('test', $time), MigrationInterface::UP);
